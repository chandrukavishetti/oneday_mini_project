...
// //           <h5 className="mb-0">{claim.employeeName}</h5>
// //           <StatusBadge status={claim.status} />
// //         </div>
        
// //         <div className="mb-2">
// //           <span className="badge bg-secondary me-1">{claim.department}</span>
// //           <span className="badge bg-info">{claim.category}</span>
// //         </div>

// //         <h4 className="text-primary mb-2">{formatCurrency(claim.amount)}</h4>
        
// //         <Row className="small text-muted mb-2">
// //           <Col xs={6}>Date: {formatDate(claim.expenseDate)}</Col>
// //           <Col xs={6}>Month: {claim.monthYear}</Col>
// //         </Row>

// //         <p className="card-text small">{claim.description}</p>
...
//         <Row className="small text-muted mb-2">
//           <Col xs={6}>Date: {getFormattedDate(claim.expenseDate)}</Col>
//           <Col xs={6}>Month: {claim.monthYear || 'N/A'}</Col>
//         </Row>
